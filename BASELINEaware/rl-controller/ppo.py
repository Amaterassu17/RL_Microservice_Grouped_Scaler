...
#
# ActorNetwork is a subclass of torch.nn.Module
# It is a neural network model for the actor in the PPO algorithm
# input_size: the size of the input state
# hidden_size: the size of the hidden layer
# output_size: the size of the output action
# 3 FC all with ReLU activation, and a softmax layer for discrete action space. dim=-1 is the last dimension
#
# forward method takes an input state and returns the output action. In this case forward pass of the network
# Continous action space is handled by a MultivariateNormal distribution. Not our case
#
...
#
# CriticNetwork is a subclass of torch.nn.Module
# It is a neural network model for the critic in the PPO algorithm
# input_size: the size of the input state
# hidden_size: the size of the hidden layer
# output_size: the size of the output value
# 3 FC all with ReLU activation, and a linear layer for the value function
#
# forward method takes an input state and returns the output value. In this case forward pass of the network
#
...
# It is a method to estimate the advantage function in reinforcement learning. It uses a list of rewards
# rewards is a list of lists 
# returns is a list of returns for each step in the episode
